...
import { Timestamp as FirebaseTimestamp, FieldValue } from 'firebase/firestore'; // Import Firebase's Timestamp and FieldValue
...
export interface ChatMessage {
  ...
  text: string;
  sender: 'user' | 'ai';
  timestamp: Date | FirebaseTimestamp | FieldValue; // Can be Date, Firebase Timestamp, or ServerTimestamp
  metadata?: Record<string, any>; // For potential grounding chunks or other info
  isError?: boolean; // To flag error messages
}
