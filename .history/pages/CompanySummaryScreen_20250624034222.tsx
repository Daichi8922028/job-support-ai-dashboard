  ...
  useEffect(() => {
    const generateSummary = async () => {
      ...
      try {
        ...
        console.log('[Debug] Raw API Response Text:', response.text);
        const parsedSummary = JSON.parse(response.text);
        console.log('[Debug] Parsed JSON Object:', parsedSummary);
        setSummary(parsedSummary.summary || parsedSummary); // Handle both { "summary": ... } and { ... }
      } catch (e: any) {
